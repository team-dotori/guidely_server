...
import dotori.guidely.domain.user.dto.response.UserResponseDto;
...
@CrossOrigin(origins = "*", allowedHeaders = "accessToken")
public class UserController {
    ...
    @GetMapping("/one")
    public ResponseEntity<UserResponseDto> findUserByAccessToken(
